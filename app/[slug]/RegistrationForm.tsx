...
const translations: Record<Language, Translations> = {
  sl: {
    ...
    successSubtext: 'Vaši podatki so shranjeni. Veselimo se, da vas bomo kmalu spoznali.',
  ...
  en: {
    ...
    successSubtext: 'Your details have been saved. We look forward to meeting you soon.',
  ...
  sr: {
    ...
    successSubtext: 'Vaši podaci su sačuvani. Radujemo se susretu sa vama.',
  ...
  hr: {
    ...
    successSubtext: 'Vaši podaci su spremljeni. Veselimo se susretu s vama.',
